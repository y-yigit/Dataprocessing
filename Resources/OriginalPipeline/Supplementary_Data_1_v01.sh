...
umi_tools dedup -I <sampleX.bam> -L <sampleX.duprm.log> -S <sampleX.duprm.bam> --extract-umi-method read_id --method directional
...
pureclip -i <merged.bam> -bai <merged.bam.bai> -g <genome.fa> -ld -nt 8 -o PureCLIP.crosslink_sites.bed -or PureCLIP.crosslink_regions.bed
